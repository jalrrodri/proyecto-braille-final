...
csv_directories = [
    ...
    'datasets/AngelinaDataset/handwritten/ang_redmi/traducido/filtros/anotaciones',
    'datasets/AngelinaDataset/handwritten/kov/traducido/filtros/anotaciones',
    'datasets/AngelinaDataset/handwritten/uploaded/traducido/filtros/anotaciones'
